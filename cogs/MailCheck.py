...
import util, os, discord, asyncio, dotenv, quopri, email, imaplib, time
...
#============================================================================================================#
    ...
    async def on_ready(self):
        if(self.client.var_start_mailcheck == True):
            self.client.var_start_mailcheck = False
            ...
            while True:
                ...
                if last_mail_uid == last_edited_uid:
                    ...
                    util.log("E-MAILS", "There is no new e-mail")
                else:
                    # If new:
                    util.log("E-MAILS", "Update: {}, {}".format(last_mail_uid, last_edited_uid))
...
def setup(client):
    ...
    util.log("Initialized cogs.MailCheck")
